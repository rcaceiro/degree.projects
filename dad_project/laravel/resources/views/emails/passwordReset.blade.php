                                                                    ...
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a target="_blank"
                                                                           class="button button-blue"
                                                                            href="{{route('index', ["all" => 'password-reset'])
                                                                             .'/'. $passwordReset->email
                                                                             .'/'. $passwordReset->token}}"
                                                                           class="button button-blue"
                                                ...
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    ...
                                                    <a target="_blank"
                                                       href="{{route('index', ["all" => 'password-reset'])
                                                                             .'/'. $passwordReset->email
                                                                             .'/'. $passwordReset->token}}"
                                                       style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{route('index', ["all" => 'password-reset'])
                                                                             .'/'. $passwordReset->email
                                                                             .'/'. $passwordReset->token}}</a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
