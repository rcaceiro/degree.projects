                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a target="_blank"
                                                                           ...
                                                                           href="{{route('index', ["all" => 'confirm-email'])
                                                                             .'/'. $confirmEmailToken->email
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        If you did not create an account on our site, no further action is required.</p>
                                    <!-- Salutation -->
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    If you’re having trouble clicking the "Confirm my account" button, copy
                                                    ...
                                                    <a target="_blank"
                                                       href="{{route('index', ["all" => 'confirm-email'])
                                                                             .'/'. $confirmEmailToken->email
                                                                             .'/'. $confirmEmailToken->token}}"
                                                       style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{route('index', ["all" => 'confirm-email'])
                                                                             .'/'. $confirmEmailToken->email
                                                                             .'/'. $confirmEmailToken->token}}</a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
