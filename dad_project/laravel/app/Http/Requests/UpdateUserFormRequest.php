...
//          anyone can send this form
    ...
    public function rules()
    {
        return [
            ...
            'nickname' => 'required|max:255|unique:users,nickname->ignore($user->id)',
            'email' => 'required|email|max:255|unique:users,email->ignore($user->id)',
            'password' => 'sometimes|confirmed|max:255|min:6'
        ];
    }
